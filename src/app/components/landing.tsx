  ...
  return (
    <>
      <div className="grid grid-cols-12 mx-auto bg-white dark:bg-black ">
        ...
        <div className="h-[20rem] flex justify-center items-center text-center col-span-8 border-t border-b border-stone-200/50 dark:border-stone-900 bg-white dark:bg-black bg-[image:var(--bg-hero)] ">
