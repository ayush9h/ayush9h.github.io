...
export default function Connect() {
  ...
  return (
    ...
    <SectionWrapper>
        <h1 className="text-2xl md:text-8xl text-center uppercase text-black font-medium font-mont p-4">
          Ayush Kumar
        </h1>
    </SectionWrapper>
    ...
    <SectionWrapper>
      ...
      <div className="grid md:grid-cols-4 sm:grid-cols-2  p-2">
          ...
          <a
            ...
            className="md:text-sm flex items-center justify-center    h-full hover:bg-white hover:text-black hover:underline transition-all duration-300 text-slate-500 font-mont space-x-2 rounded-md px-4"
          >
      ...
      <SectionWrapper>
        <h1 className="text-md text-center text-slate-400/65 font-mont p-4">
