...
export default function Connect() {
  ...
  return (
    <>
        ...
        <div className="grid md:grid-cols-4 sm:grid-cols-2  p-2">
          {links.map((link, i) => (
            <a
              ...
              className="md:text-sm flex items-center justify-center    h-full hover:bg-white hover:text-black hover:underline transition-all duration-300 text-stone-500 font-mont space-x-2 rounded-md px-4"
            >
      ...
      <SectionWrapper>
        <h1 className="text-md text-center text-stone-400/65 font-mont p-4">
