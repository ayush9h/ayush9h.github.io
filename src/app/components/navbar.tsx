      ...
      <div className="flex justify-between items-center p-2">
        ...
        <div className="flex items-center justify-between gap-3">
          <div
            ...
            className="flex items-center gap-1 px-2 py-1.5 rounded-full border border-stone-300 shadow-sm cursor-pointer transition-all"
          >
            <MagnifyingGlassIcon className="text-black" />
            <div className="flex items-center gap-1">
              <kbd className="sm:inline-flex rounded px-1 border border-stone-300 bg-stone-100 text-xs font-mont shadow-sm">
                Ctrl
              </kbd>
              <kbd className="sm:inline-flex rounded px-1 border border-stone-300 bg-stone-100 text-xs font-mont shadow-sm">
                K
