      ...
      <SectionWrapper>
        <div className="border-r border-stone-200/50">
          {projects.map((item, i) => (
            <div
              key={i}
              className="space-y-2 p-2 md:p-8 border-b border-stone-200"
            >
              ...
              <div className="flex items-center gap-2 cursor-pointer hover:underline">
                ...
                <a
                  target="_blank"
                  href={item.link}
                  className="link-text font-mont text-xl font-semibold"
                >
                  {item.title}
                </a>
              </div>
          ...
          <div className=" flex justify-center items-center text-center">
            <a
              ...
              className="mt-2 mb-2 mx-auto w-[10rem] p-2 rounded-full flex justify-center items-center text-center font-mont 
                           bg-gradient-to-b from-black via-stone-800 to-gray-700 
                           hover:from-gray-800 hover:via-black hover:to-stone-900
                           shadow-md hover:shadow-xl transition-all duration-300
                           text-sm text-stone-200 uppercase"
            >
              see all projects
            </a>
          </div>
